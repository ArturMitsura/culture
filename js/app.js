(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".info-page__slider")) new core(".info-page__slider", {
    ...
    let arrow = document.querySelectorAll(".menu__item");
    for (let i = 0; i < arrow.length; i++) {
        let subMenu = arrow[i].lastElementChild;
        let thisArrow = arrow[i];
        arrow[i].addEventListener("click", (function() {
            subMenu.classList.toggle("open");
            thisArrow.classList.toggle("active");
            _slideToggle(thisArrow.lastElementChild, 500);
        }));
    }
    window["FLS"] = true;
    isWebp();
